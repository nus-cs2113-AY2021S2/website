...
<div id="getting-started-ghclassroom">

## Getting started with GitHub Classroom

* Retrieve the links to a particular assignment from the GitHub Classroom exericses page.
  {{ embed_topic("githubclassroomexercises.md#ghclassroom-exercises-list" ,"Admin " + icon_embedding + " **GitHub Classroom exercises**", "2", indent="1", status="collapsed") }}
